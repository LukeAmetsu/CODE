...
const validationRules = {
    ...
    splice: {
        ...
        'H_fp': { min: 1, required: (inputs) => inputs.num_flange_plates > 0, label: 'Flange Plate Width' },
        't_fp': { min: 0.1, required: (inputs) => inputs.num_flange_plates > 0, label: 'Flange Plate Thickness' },
        'L_fp': { min: 1, required: (inputs) => inputs.num_flange_plates > 0, label: 'Flange Plate Length' },
        'H_wp': { min: 1, required: (inputs) => inputs.num_web_plates > 0, label: 'Web Plate Height' },
        't_wp': { min: 0.1, required: (inputs) => inputs.num_web_plates > 0, label: 'Web Plate Thickness' },
        'L_wp': { min: 1, required: (inputs) => inputs.num_web_plates > 0, label: 'Web Plate Length' },
        'D_fp': { min: 0.1, required: (inputs) => inputs.num_flange_plates > 0, label: 'Flange Bolt Diameter' },
        'D_wp': { min: 0.1, required: (inputs) => inputs.num_web_plates > 0, label: 'Web Bolt Diameter' },
    }
    ,
    splice: {
        'member_d': { min: 1, required: true, label: 'Member Depth' },
